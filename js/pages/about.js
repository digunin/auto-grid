        ...
        <ul>
          <li>
            <DefinitionFragment term="Офсетная печать">
              ...
              <span>
                Заготовка по сути уже является готовой картой белого цвета.
                Офсетным этот способ называется из-за метода передачи краски с
                печатной формы на заготовку. Приложение сделано не для офсетной
          ...
          <li>
            <DefinitionFragment term={`"Цифровая" печать`}>
              ...
              <span>
                ...
                расположение макетов карт на листе. У нас используется модель с
                пятью вырубными элементами (к сожалению, конструкция вырубщика
                не позволяет сделать нормальные фотографии с общим планом).
              </span>
          ...
          <li>
            <DefinitionFragment term={'Персонализация карт'}>
              ...
              <span>
                ...
                кодирование магнитной полосы), но они не имеют отношения к
              ...
              <span>
                При "цифровом" способе печати можно заодно печатать и
              ...
              <span>
                ...
                публике неизвестен) удобного способа изготавливать карты
                "цифровым" методом с заранее напечатанной персональной
